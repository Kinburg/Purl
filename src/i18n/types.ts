...
export interface Translations {
  ...
  addBlock: {
    ...
    videoGen:    { label: string; desc: string };
  ...
  imageGenBlock: {
    ...
    inputImageHint: string;
    inputImageFromAsset: string;
    inputImageFromFile: string;
    inputImageClear: string;
    inputImageReplace: string;
    readFromFolderLabel: string;
    readFromFolderHint: string;
    readFromFolderNeedsSetting: string;
  };
  ...
  videoGenBlock: {
    ...
    keyframesHint: string;
    keyframesAddAsset: string;
    keyframesAddFiles: string;
    keyframesEmpty: string;
    keyframesMinNote: string;
    keyframeUp: string;
    keyframeDown: string;
    keyframeRemove: string;
    keyframeReplace: string;
    keyframePromptPlaceholder: string;
    keyframeTransitionLabel: string;
    promptLabel: string;
    promptPlaceholder: string;
    negativePromptLabel: string;
    negativePromptPlaceholder: string;
    ...
    draftBadge: string;
    approveVideo: string;
    approveVideoTitle: string;
    unapproveVideo: string;
    unapproveVideoTitle: string;
    previewAlt: string;
    widthLabel: string;
    widthPlaceholder: string;
    playbackControls: string;
    playbackAutoplay: string;
    playbackLoop: string;
    approveSaveTitle: string;
    approveFolderLabel: string;
    approveFilenameLabel: string;
    ...
    errorNoWorkflow: string;
    errorNoPrompt: string;
    errorNeedKeyframes: string;
    errorGenerateVideo: string;
    errorApprove: string;
    errorUnapprove: string;
  };
  ...
  llmSettingsModal: {
    ...
    comfyUiOutputDirLabel: string;
    comfyUiOutputDirPlaceholder: string;
    comfyUiOutputDirHint: string;
    pollinationsModelLabel: string;
    pollinationsModelPlaceholder: string;
    pollinationsTokenLabel: string;
    pollinationsTokenPlaceholder: string;
